# OTAP Bluetooth Low Energy

Two types of flows for the Bluetooth LE case are as follows:

* [Encrypted transfers using an `.sb3` container](encrypted-bluetooth-le.md). Applicable for the following devices:
  * KW45B41Z-EVK
  * FRDM-MCXW71
  * MCXW71-EVK
  * KW47-EVK
  * FRDM-MCXW72
  * MCXW72-EVK
* [Plain-binary transfers](plain-bin-transfers-bluetooth-le.md). Applicable for the following devices:
  * FRDM-MCXW23
  * MCXW23-EVK
  * KW36
  * KW38
